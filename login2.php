...
<div class="demo-layout mdl-layout mdl-layout--fixed-header mdl-js-layout mdl-color--grey-100">
    ...
    <main class="demo-main mdl-layout__content">
        <div class="demo-container mdl-grid" style="margin-top: 200px; padding-top: 50px">
            <div class="mdl-cell mdl-cell--2-col mdl-cell--hide-tablet mdl-cell--hide-phone"></div>
            <div class="demo-content mdl-color--cus mdl-shadow--4dp content mdl-color-text--grey-800 mdl-cell mdl-cell--8-col" style="margin-bottom: 20px">
                ...
                <div class="demo-card-wide mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h2 class="mdl-card__title-text">ConsensUs Pilot Study</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                        Welcome to Design Lab's ConsensUs Pilot Study.<br>
                        Please login with the E-mail and Password provided by us.
                        <br>
                        <br>
        ...
        if(isset($_POST['email']) && isset($_POST['password'])){
            ...
            if($row_count[0]==0) {
                $alertText = "Wrong Email or Password";
