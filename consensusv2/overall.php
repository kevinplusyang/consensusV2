...
<p style="padding-left: 10px">
    ...
    <br>
    Click on candidates to change your vote and see other's votes<br>
</p>
...
<div style="width:1000px;float:right;">
    ...
    <a href="decision_post.php?decision_id=<?php echo $_GET['decision_id']?>&user=<?php echo $_GET['user_id'];?>" class="button button-rounded button-raised" style="margin-left: 750px;  margin-top: 5px; float:left">Next</a>
...
//                        .attr("transform", "translate(100, 0)")
                    ...
                    var data1 = [{rect:0, name:"Overall"},{rect:1, name:"Academic"},{rect:2, name:"Extracurricular"},{rect:3, name:"Recommendation Letter"}];
