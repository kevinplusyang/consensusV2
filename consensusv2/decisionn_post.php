...
//                            .attr("transform", "translate(100, 0)")
                        ...
                        var data1 = [{rect:0, name:"Overall"},{rect:1, name:"Academic"},{rect:2, name:"Extracurricular"},{rect:3, name:"Recommondation Letter"}];
...
//                        tableChanged(d.row, d.col, score_num);
                        ...
                        var check_box = d3
                            ...
                            .style("left", 1074  + "px")
                            .style("top", function() { return 230 + "px";})
                            .append('input')
                            .attr('type','checkbox')
