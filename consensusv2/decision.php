...
<p style="padding-left: 10px">
    ...
    Click and drag the colored circles onto the line<br>
    <br>
</p>
...
<div style="width:1200px;float:left">
    <a href="overall.php?decision_id=<?php echo $_GET['decision_id']?>&user_id=<?php echo $_GET['user'];?>" class="button button-rounded button-raised" style="margin-left: 1050px;  margin-top: 5px; float:left">Next</a>
